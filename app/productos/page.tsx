...
export default function ProductosPage() {
  const categorias = [
    { nombre: "Videos Corporativos", color: "from-blue-600 to-blue-700", slug: "cocinas-industriales" },
    { nombre: "Dirección de Fotografía", color: "from-purple-600 to-purple-700", slug: "hornos" },
    { nombre: "Edición y Post-producción", color: "from-pink-600 to-pink-700", slug: "asadores" },
    { nombre: "Motion Graphics", color: "from-indigo-600 to-indigo-700", slug: "barriles" },
    { nombre: "Documentales", color: "from-cyan-600 to-cyan-700", slug: "freidoras" },
    { nombre: "Publicidad y Comerciales", color: "from-violet-600 to-violet-700", slug: "refrigeracion" },
    { nombre: "Transmisión en Vivo", color: "from-emerald-600 to-emerald-700", slug: "mesas-de-trabajo" },
    { nombre: "Consultoría Audiovisual", color: "from-orange-600 to-orange-700", slug: "self-services" },
  ];
