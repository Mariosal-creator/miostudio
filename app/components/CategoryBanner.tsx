...
export default function CategoryBanner({ title, breadcrumb = ["Inicio", "Productos"], backgroundVideo, messages, intervalMs = 3500 }: Props) {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {messages && messages.length > 0 ? (
          ...
          <div className="flex items-center justify-between py-3 sm:py-4">
            ...
            <a
              href="https://wa.me/593963163035?text=Hola%20Metalgas%20%2D%20quisiera%20asesor%C3%ADa"
